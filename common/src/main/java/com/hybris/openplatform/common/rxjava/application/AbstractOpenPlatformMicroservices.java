package com.hybris.openplatform.common.rxjava.application;
...
import com.hybris.openplatform.common.rxjava.vertx.MainMicroServiceVerticle;
...
public abstract class AbstractOpenPlatformMicroservices
{
	private static final Logger LOG = LoggerFactory.getLogger(
			AbstractOpenPlatformMicroservices.class);

	private MainMicroServiceVerticle mainMicroServiceRxVerticle;
	private Vertx vertx;
	...
	{
		this.mainMicroServiceRxVerticle = mainMicroServiceVerticle;
	}
